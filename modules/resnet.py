...
class ResNet(nn.Module):
    ...
    def _forward_impl(self, x):
        ...
        # # capture the feature matrix of images
        # x_copy = x.clone().detach()
        # features_for_ensemble_cluster.append(x_copy.view(x.size(0), -1))
        # return x, features_for_ensemble_cluster
